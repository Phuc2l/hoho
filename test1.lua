...
getgenv()['Check_Setting'] = function(Name)
    if not _G.Dis and not isfolder('Demon LT Hub BF On Top') then
        makefolder('Demon LT Hub BF On Top')
    end
    if not _G.Dis and not isfile('Demon LT Hub BF On Top/'..Name..'.json') then
        writefile('Demon LT Hub BF On Top/'..Name..'.json',JsonEncode(_G.Setting_table))
    end
end
getgenv()['Get_Setting'] = function(Name)
    if not _G.Dis and isfolder('Demon LT Hub BF On Top') and isfile('Demon LT Hub BF On Top/'..Name..'.json') then
        _G.Setting_table = JsonDecode(readfile('Demon LT Hub BF On Top/'..Name..'.json'))
...
getgenv()['Update_Setting'] = function(Name)
    if not _G.Dis and isfolder('Demon LT Hub BF On Top') and isfile('Demon LT Hub BF On Top/'..Name..'.json') then
        writefile('Demon LT BF On Top/'..Name..'.json',JsonEncode(_G.Setting_table))
	elseif not _G.Dis then
        Check_Setting(Name)
    end
end
